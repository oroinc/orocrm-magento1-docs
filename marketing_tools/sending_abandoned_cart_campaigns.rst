...
It is necessary to have an active MailChimp Integration to be able to send an ACC.

Step 2: Add an Abandoned Cart to the Channel
--------------------------------------------

Create a Magento Channel for which your ACC will be used. Make sure that all
...
Record**. When creating the record, make sure that:
